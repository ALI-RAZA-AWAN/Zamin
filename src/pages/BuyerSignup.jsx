  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4 font-sans">
      <div className="w-full max-w-md bg-white border border-gray-200 rounded-2xl shadow-xl p-6 md:p-8">
        ...
        <h2 className="text-xl font-black text-gray-900">Register as Brand Buyer</h2>
        ...
        <form onSubmit={submitRegister} className="space-y-4">
          ...
          {/* ✅ FIXED: Emerald Theme Button */}
          <button type="submit" className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-2.5 rounded-xl text-sm uppercase tracking-wider transition-all">Register as Buyer</button>
        </form>
      </div>
    </div>
  );
