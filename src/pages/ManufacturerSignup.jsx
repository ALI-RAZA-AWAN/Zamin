  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4 font-sans">
      <div className="w-full max-w-md bg-white border border-gray-200 rounded-2xl shadow-xl p-6 md:p-8">
        ...
        <h2 className="text-xl font-black text-[#B8965F]">Register Factory Unit</h2>
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          ...
          <button type="submit" className="w-full bg-gray-700 hover:bg-gray-900 text-white font-bold py-2.5 rounded-xl text-sm uppercase tracking-wider">Register Factory</button>
        </form>
      </div>
    </div>
  );
